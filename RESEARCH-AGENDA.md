...
This agenda describes the questions we want to investigate. It is a statement of direction, with priorities that may evolve as evidence and practical needs develop. Each individual study will define its own scope, method and publication status.

## 1. AI in accounting and financial management

Our central question is how AI can make financial work more useful, understandable and dependable for the people responsible for it.

Questions of interest include:

- How accurately can systems extract and classify information from varied financial documents, including incomplete or ambiguous inputs?
- How should deterministic checks, model outputs and human review work together in an accounting workflow?
- Which errors matter most to the user, and how should an evaluation reflect their consequences?
...
Our central question is how to preserve the intended behaviour of a service as its dependencies and operating conditions change.

Questions of interest include:

- Which behaviours must be retested before replacing a model in an established workflow?
- How can evaluations examine tool use, retrieval, permissions and human review alongside answer quality?
- What minimum service can a system maintain during a provider or infrastructure disruption?
...
Our central question is how countries turn resources and access into useful, sustainable AI capability—and what the UK can credibly learn from their experience.

Questions of interest include:

- What do investment, market activity, technical capability and adoption each reveal, and what do they leave unexplained?
- Where is economic value created, and where is it captured?
- How do access to compute, talent, data and infrastructure affect a country's options?
